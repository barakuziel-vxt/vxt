...
BEGIN
    ...
    -- ============ JUNCTION EXTRACTION RULES (ValueJsonPath, SampleArrayPath, CompositeValueTemplate) ============
    IF @JunctionProviderId IS NOT NULL
    BEGIN
        UPDATE dbo.ProviderEvent SET ValueJsonPath = N'$.data.heart_rate_data.summary.avg_hr_bpm', SampleArrayPath = N'$.data.heart_rate_data.detailed.hr_samples', CompositeValueTemplate = N'{"valueKey": "bpm", "timestampKey": "timestamp"}' WHERE providerId = @JunctionProviderId AND providerEventType = 'vitals.heart_rate.update';
        UPDATE dbo.ProviderEvent SET ValueJsonPath = N'$.data.blood_pressure_data.summary.avg_systolic_mmhg', SampleArrayPath = N'$.data.blood_pressure_data.detailed.bp_samples', CompositeValueTemplate = N'{"valueKey": "systolic_mmhg", "timestampKey": "timestamp"}' WHERE providerId = @JunctionProviderId AND providerEventType = 'vitals.blood_pressure.update';
        UPDATE dbo.ProviderEvent SET ValueJsonPath = N'$.data.temperature_data.summary.avg_celsius', SampleArrayPath = N'$.data.temperature_data.detailed.temperature_samples', CompositeValueTemplate = N'{"valueKey": "celsius", "timestampKey": "timestamp"}' WHERE providerId = @JunctionProviderId AND providerEventType = 'vitals.body_temperature.update';
        UPDATE dbo.ProviderEvent SET ValueJsonPath = N'$.data.oxygen_data.summary.avg_saturation_percentage', SampleArrayPath = N'$.data.oxygen_data.detailed.saturation_samples', CompositeValueTemplate = N'{"valueKey": "percentage", "timestampKey": "timestamp"}' WHERE providerId = @JunctionProviderId AND providerEventType = 'vitals.oxygen_saturation.update';
        UPDATE dbo.ProviderEvent SET ValueJsonPath = N'$.data.respiration_data.summary.avg_breaths_per_min', SampleArrayPath = N'$.data.respiration_data.detailed.breaths_samples', CompositeValueTemplate = N'{"valueKey": "breaths_per_min", "timestampKey": "timestamp"}' WHERE providerId = @JunctionProviderId AND providerEventType = 'vitals.respiration_rate.update';
        UPDATE dbo.ProviderEvent SET ValueJsonPath = N'$.data.hrv_data.summary.avg_rmssd_ms', SampleArrayPath = N'$.data.hrv_data.detailed.hrv_samples', CompositeValueTemplate = N'{"valueKey": "rmssd_ms", "timestampKey": "timestamp"}' WHERE providerId = @JunctionProviderId AND providerEventType = 'vitals.heart_rate_variability.update';
        UPDATE dbo.ProviderEvent SET ValueJsonPath = N'$.data.glucose_data.summary.avg_glucose_mg_dl', SampleArrayPath = N'$.data.glucose_data.detailed.glucose_samples', CompositeValueTemplate = N'{"valueKey": "glucose_mg_dl", "timestampKey": "timestamp"}' WHERE providerId = @JunctionProviderId AND providerEventType = 'vitals.glucose.update';
        UPDATE dbo.ProviderEvent SET ValueJsonPath = N'$.data.glucose_data.summary.avg_glucose_mg_dl' WHERE providerId = @JunctionProviderId AND providerEventType = 'vitals.glucose.serum.update';
        UPDATE dbo.ProviderEvent SET ValueJsonPath = N'$.data.diastolic_bp_data.summary.avg_diastolic_mmhg', SampleArrayPath = N'$.data.diastolic_bp_data.detailed.diastolic_samples', CompositeValueTemplate = N'{"valueKey": "diastolic_mmhg", "timestampKey": "timestamp"}' WHERE providerId = @JunctionProviderId AND providerEventType = 'vitals.diastolic_blood_pressure.update';
        UPDATE dbo.ProviderEvent SET ValueJsonPath = N'$.data.resting_hr_data.summary.avg_resting_hr_bpm', SampleArrayPath = N'$.data.resting_hr_data.detailed.resting_hr_samples', CompositeValueTemplate = N'{"valueKey": "bpm", "timestampKey": "timestamp"}' WHERE providerId = @JunctionProviderId AND providerEventType = 'vitals.heart_rate.resting.update';
        UPDATE dbo.ProviderEvent SET ValueJsonPath = N'$.data.min_hr_data.summary.avg_min_hr_bpm', SampleArrayPath = N'$.data.min_hr_data.detailed.min_hr_samples', CompositeValueTemplate = N'{"valueKey": "bpm", "timestampKey": "timestamp"}' WHERE providerId = @JunctionProviderId AND providerEventType = 'vitals.heart_rate.minimum.update';
        UPDATE dbo.ProviderEvent SET ValueJsonPath = N'$.data.max_hr_data.summary.avg_max_hr_bpm', SampleArrayPath = N'$.data.max_hr_data.detailed.max_hr_samples', CompositeValueTemplate = N'{"valueKey": "bpm", "timestampKey": "timestamp"}' WHERE providerId = @JunctionProviderId AND providerEventType = 'vitals.heart_rate.maximum.update';
        UPDATE dbo.ProviderEvent SET ValueJsonPath = N'$.data.afib_data.summary.detection_count', SampleArrayPath = N'$.data.afib_data.detailed.afib_samples', CompositeValueTemplate = N'{"valueKey": "detected", "timestampKey": "timestamp"}' WHERE providerId = @JunctionProviderId AND providerEventType = 'vitals.atrial_fibrillation_detection.update';
        UPDATE dbo.ProviderEvent SET ValueJsonPath = N'$.data.steps_data.summary.total_steps', SampleArrayPath = N'$.data.steps_data.detailed.hourly_steps', CompositeValueTemplate = N'{"valueKey": "hourly_steps", "timestampKey": "timestamp"}' WHERE providerId = @JunctionProviderId AND providerEventType = 'activity.steps.update';
        UPDATE dbo.ProviderEvent SET ValueJsonPath = N'$.data.calories_data.summary.total_calories_burned', SampleArrayPath = N'$.data.calories_data.detailed.activity_samples', CompositeValueTemplate = N'{"valueKey": "calories_burned", "timestampKey": "timestamp"}' WHERE providerId = @JunctionProviderId AND providerEventType = 'activity.calories.update';
        UPDATE dbo.ProviderEvent SET ValueJsonPath = N'$.data.distance_data.summary.total_distance_km', SampleArrayPath = N'$.data.distance_data.detailed.route_samples', CompositeValueTemplate = N'{"valueKey": "segment_distance_km", "timestampKey": "timestamp"}' WHERE providerId = @JunctionProviderId AND providerEventType = 'activity.distance.update';
        UPDATE dbo.ProviderEvent SET ValueJsonPath = N'$.data.sleep_data.summary.total_sleep_minutes', SampleArrayPath = N'$.data.sleep_data.detailed.sleep_stages', CompositeValueTemplate = N'{"valueKey": "stage", "timestampKey": "timestamp"}' WHERE providerId = @JunctionProviderId AND providerEventType = 'sleep.session.created';
        UPDATE dbo.ProviderEvent SET ValueJsonPath = N'$.data.sleep_data.summary.total_sleep_minutes', SampleArrayPath = N'$.data.sleep_data.detailed.sleep_stages', CompositeValueTemplate = N'{"valueKey": "stage", "timestampKey": "timestamp"}' WHERE providerId = @JunctionProviderId AND providerEventType = 'sleep.session.updated';
        UPDATE dbo.ProviderEvent SET ValueJsonPath = N'$.data.location_data.summary.current_latitude', SampleArrayPath = N'$.data.location_data.detailed.gps_track', CompositeValueTemplate = N'{"valueKey": "latitude", "timestampKey": "timestamp"}' WHERE providerId = @JunctionProviderId AND providerEventType = 'location.update';
    END
